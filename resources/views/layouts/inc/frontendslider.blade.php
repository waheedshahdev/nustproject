	...
	<section id="home" class="no-padding">	
    	<div id="main-slide" class="cd-hero">
			<ul class="cd-hero-slider">
				...
				<li>
					<div class="overlay2">
						<img class="" src="{{ asset('frontend/images/slider/bg2.jpg')}}" alt="slider">
					</div>
					...
					<div class="cd-half-width cd-img-container">
						<img src="{{ asset('frontend/images/slider/bg-thumb1.png')}}" alt="">
					</div> <!-- .cd-half-width.cd-img-container -->
				</li>
				<li>
					<div class="overlay2">
						<img class="" src="{{ asset('frontend/images/slider/bg3.jpg')}}" alt="slider">
					</div>
					<div class="cd-half-width cd-img-container img-right">
						<img src="{{ asset('frontend/images/slider/bg-thumb2.png')}}" alt="">
					</div> <!-- .cd-half-width.cd-img-container -->
					<div class="cd-half-width">
						<h2>Your Challenge is Our Progress</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. In consequatur cumque natus!</p>
						<a href="#0" class="cd-btn btn btn-primary white">Start</a>
						<a href="#0" class="cd-btn btn secondary btn-primary solid">Discover More</a>
					</div> <!-- .cd-half-width -->
				</li>
				<li class="cd-bg-video">
					<div class="cd-full-width">
						...
						<a href="#0" class="cd-btn btn btn-primary solid">Discover More</a>
					</div> <!-- .cd-full-width -->
