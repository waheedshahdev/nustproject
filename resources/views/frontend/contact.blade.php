			...
			<div class="row">
	    		...
	    		<div class="col-md-5">
	    			<div class="contact-info">
			    		...
			    		<br>
			    		<p><i class="fa fa-home info"></i>  1102 Saint Marys, test city, Test </p>
						<p><i class="fa fa-phone info"></i>  +92 (324) 238-4131 </p>
						<p><i class="fa fa-envelope-o info"></i>  info@nust.com</p>
